    ...
    while(1) {
        ...
        scanf("%d",&sayi);
         ...
         printf("Bu ucgen ayni zamanda bir dik ucgendir.\n");
            ...
            printf("1. ve 2.kenar arasindaki aci:\n");
            scanf("%f", &w1);

            printf("2. ve 3.kenar arasindaki aci:\n");
            scanf("%f", &w2);

            w4= 180/PI*acos((q1*q1+q4*q4-q2*q2-q3*q3+2*q2*q3*cos(w2*PI/180))/(2*q1*q4));
            w3= 360-(w1+w2+w4);
            printf("3. ve 4.kenar arasindaki aci:\n%f\n",w3);
        
            printf("4. ve 1.kenar arasindaki aci:\n%f\n", w4);

            if (((q1 == q2)&&(q1==q3)&&(q1==q4)) && ((w1 == w3) && (w2 == w4) && ((w1 != w4) && (w2 != w3)))) {
                printf("Sekliniz Eskenar Dortgen!\n");
                printf("Alani:%f\n\n", ((q1 * q2 * sin(w1* PI/180)) / 2) + ((q3 * q4 * sin(w3* PI/180)) / 2));
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
                ...
                printf("Alani:%f\n\n", q1 * q2);
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
            } else if (((q1 == q2)&&(q1==q3)&&(q1==q4)) && (w1 == 90 && w2 == 90 && w3 == 90 && w4 == 90)) {
                printf("Sekliniz Kare!\n");
                printf("Alani:%f\n\n", q1 * q2);
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
            } else if (((q1 != q2) && (q3 != q4)) && ((q1 == q3) && (q2 == q4)) && ((w1 == w3) && (w2 == w4))) {
                printf("Sekliniz Paralel Kenar!\n");
                printf("Alani:%f\n\n", ((q1 * q2 * sin(w1* PI/180)) / 2) + ((q3 * q4 * sin(w3* PI/180)) / 2));
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
            } 
            else if ((q1!=q3 && w1+w2==180 && w3+w4==180) ){
                if(q2==q4){
                    printf ("Sekliniz ikizkenar yamuktur\n");
                }
                
                else if (w1==90 || w3==90){
                    printf ("Sekliniz dik kenar yamuktur\n");
                }
                else{
                    printf("Sekliniz Yamuk!\n");
                }
                
                printf("Alani:%f\n\n", (0.5* sin(w3* PI/180)*q4*(q1+q3)));
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
            }
            else {
                printf("Sekliniz Cesitkenar Dortgen!\n");
                printf("Alani:%f\n\n", ((q1 * q2 * sin(w1* PI/180)) / 2) + ((q3 * q4 * sin(w3)) / 2));
                printf("Ana sayfaya yonlendiriliyorsunuz...\n\n");
            }
        } else if (sayi == 3) {
            kenarsayisi();
